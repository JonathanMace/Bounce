...
public abstract class TimeAttackHUD extends BaseHUD {
	...
	protected final String CURRENT_TEXT = "Elapsed: ";
     ...
     */
    public TimeAttackHUD(Scene scene, TextureBucket textures, Font font) {
    ...
    public void setBest(Long best) {
    	bestScore.setText(BEST_TEXT+formatTime(best));
    }
    
    public void setCurrent(Long current) {
    	currentBounces.setText(CURRENT_TEXT+formatTime(current));
    }

    public void setTarget(Long target) {
    	bestScore.setText(TARGET_TEXT+formatTime(target));
    }
    
    private String formatTime(Long nanoseconds) {
    	float seconds = (float) (nanoseconds / ((double) 1000000000));
