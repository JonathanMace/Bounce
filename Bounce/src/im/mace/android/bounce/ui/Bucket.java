...
public class Bucket {
	...
	private Body[] bucketParts = new Body[3];
    ...
    public void attach(Scene scene, PhysicsWorld world) {
        ...
        bucketParts[0]=PhysicsFactory.createBoxBody(world, ground, BodyType.StaticBody, Constants.BUCKET_FIXTURE_DEF);
        bucketParts[1]=PhysicsFactory.createBoxBody(world, leftWall, BodyType.StaticBody, Constants.BUCKET_FIXTURE_DEF);
        bucketParts[2]=PhysicsFactory.createBoxBody(world, rightWall, BodyType.StaticBody, Constants.BUCKET_FIXTURE_DEF);
    }
    ...
    /**
     * Test whether the given body is part of the bucket or not
     */
    public boolean isPartOfBucket(Body x, PhysicsWorld world) {
    	for (Body part : bucketParts) {
            if (x==part) {
            	return true;
            }
    	}
